...
% TODO: (wartena) That is true, but maybe you should discusss this in more detail in the related work. There has bee a lot of debate about this, and in fact there is no theoretic justification for taking the average. Since "snetnece embedding"is even in the title, it would be good to discuss the step from words to sentences a little bit.
