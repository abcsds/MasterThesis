...
Due to availability, the selected datasets are CrowdFlower, EmotionPush, and Friends.
...
From these, empty, and neutral were taken off the dataset. More about this on~\ref{chap:Methodology}.
